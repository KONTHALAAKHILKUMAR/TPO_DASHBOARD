    ...
    const scheduleProgress = new Chart(ctx1, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [40, 50, 60],
                backgroundColor: ['#f86d7d', '#6295f8', '#615cff'],
                borderColor: '#ffffff',  // white gaps between segments
                borderWidth: 5  // adjust the gap size
            }]
        },
        options: {
            cutout: '70%',  // This creates the empty space for the text inside the donut chart
            plugins: {
                legend: {
                    display: false,  // Force remove legend
                    labels: {
                        display: false   // Extra fallback for label removal
                    }
                },
                tooltip: {
...
const completionprogress = new Chart(ctx, {
    ...
    //     plugins: {
    //         legend: {
    //             display: false,  // Force remove legend for Project Progress
    //             labels: {
    //                 display: false   // Extra fallback for label removal
    //             }
    //         },
    ...
    //     categoryPercentage: 0.3,  // Adjust spacing between bars
    // }
    // });
